/// The Move eth fungible asset module.
module move_eth::move_eth {
    ...
    public fun moveth_address(): address {
        object::create_object_address(&@move_eth, ASSET_SYMBOL)
    }
    ...
    spec denylist {
        ...
        // let x =  borrow_global<Roles>(moveth_address());
        // aborts_if ! (signer::address_of(denylister) == borrow_global<Roles>(moveth_address()).denylister);
        // ensures !exists
    }
